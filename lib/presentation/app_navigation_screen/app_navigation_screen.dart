...
class AppNavigationScreen extends StatelessWidget {
  ...
  onTapDashboardContainer(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.dashboardContainer1Screen);
  }
  ...
  onTapSeeMoreSeven(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.seeMoreSevenScreen);
  }
  ...
  onTapSeeMoreEight(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.seeMoreEightScreen);
  }
  ...
  onTapExploreSix(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.exploreSixScreen);
  }
  ...
  onTapExploreSeven(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.exploreSevenScreen);
  }
  ...
  onTapExploreTen(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.exploreTenScreen);
  }
  ...
  onTapChannelFive(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.channelFiveScreen);
  }
  ...
  onTapSearchSevenTabContainer(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.searchSevenTabContainerScreen);
  }
  ...
  onTapSearchTen(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.searchTenScreen);
  }
  ...
  onTapSearchSix(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.searchSixScreen);
  }
  ...
  onTapSearchEight(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.searchEightScreen);
  }
  ...
  onTapSearchNine(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.searchNineScreen);
  }
}
